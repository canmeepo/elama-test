...
gulp.task('img', function() {
  return gulp
    .src('src/assets/img/**', { since: gulp.lastRun('img') })
    .pipe(newer('dist/img'))
...
gulp.task('lib', function() {
  return gulp
    .src('src/assets/scripts/lib/*.js', { since: gulp.lastRun('lib') })
...
gulp.task(
  'build',
  gulp.series('clean', gulp.parallel('styles', 'img', 'fonts', 'lib', 'js', 'handlebars'))
);
